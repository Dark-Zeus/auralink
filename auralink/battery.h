...
constexpr uint8_t BATTERY_LEVEL_PIN = 15;
...
public:
  ...
  float voltage(float v_min = 3.0f, float v_max = 4.2f, uint16_t raw_min = 300, uint16_t raw_max = 2320) const;
  int   percent(float v_min = 3.0f, float v_max = 4.2f, uint16_t raw_min = 300, uint16_t raw_max = 2320) const;
